...
public class HybridConfiguratorScreen extends AbstractContainerScreen<HybridConfiguratorMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MinecraftFarmerTechMod.MOD_ID, "textures/gui/hybrid_configurator_gui.png");
    public HybridConfiguratorScreen(HybridConfiguratorMenu menu, Inventory playerInventory, Component title) { super(menu, playerInventory, title); }
