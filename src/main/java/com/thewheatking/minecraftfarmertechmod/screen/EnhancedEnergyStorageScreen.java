...
public class EnhancedEnergyStorageScreen extends AbstractContainerScreen<EnhancedEnergyStorageMenu> {
    ...
    protected void renderTooltip(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        if (mouseX >= barX && mouseX <= barX + ENERGY_BAR_WIDTH &&
            ...
            tooltip.add(Component.literal("Enhanced Energy Storage"));
            ...
            tooltip.add(Component.literal("Capacity: 200,000 FE"));
            tooltip.add(Component.literal("Transfer: 5,000 FE/t"));
