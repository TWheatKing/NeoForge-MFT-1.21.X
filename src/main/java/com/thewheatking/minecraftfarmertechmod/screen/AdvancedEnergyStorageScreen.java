...
public class AdvancedEnergyStorageScreen extends AbstractContainerScreen<HybridMenuTypes.AdvancedEnergyStorageMenu> {
    ...
    protected void renderTooltip(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        if (mouseX >= barX && mouseX <= barX + ENERGY_BAR_WIDTH &&
            ...
            tooltip.add(Component.literal("Advanced Energy Storage"));
            ...
            tooltip.add(Component.literal("Capacity: 1,000,000 FE"));
            tooltip.add(Component.literal("Transfer: 20,000 FE/t"));
