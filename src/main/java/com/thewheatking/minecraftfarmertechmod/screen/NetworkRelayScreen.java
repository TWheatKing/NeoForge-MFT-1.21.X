...
public class NetworkRelayScreen extends AbstractContainerScreen<HybridMenuTypes.NetworkRelayMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        renderNetworkElements(guiGraphics, x, y);
    }

    private void renderNetworkElements(GuiGraphics guiGraphics, int x, int y) {
        // Network signal indicators
        guiGraphics.fill(x + 60, y + 25, x + 120, y + 45, 0xFF00AA00); // Green network area
    }
