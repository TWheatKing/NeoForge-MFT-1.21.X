...
public class NetworkRelayScreen extends AbstractContainerScreen<NetworkRelayMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MinecraftFarmerTechMod.MOD_ID, "textures/gui/network_relay_gui.png");
    public NetworkRelayScreen(NetworkRelayMenu menu, Inventory playerInventory, Component title) { super(menu, playerInventory, title); }
