...
public class NetworkAmplifierScreen extends AbstractContainerScreen<NetworkAmplifierMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MinecraftFarmerTechMod.MOD_ID, "textures/gui/network_amplifier_gui.png");
    public NetworkAmplifierScreen(NetworkAmplifierMenu menu, Inventory playerInventory, Component title) { super(menu, playerInventory, title); }
