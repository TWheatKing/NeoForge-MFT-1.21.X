...
public class SuperiorEnergyStorageScreen extends AbstractContainerScreen<SuperiorEnergyStorageMenu> {
    ...
    protected void renderTooltip(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        if (mouseX >= barX && mouseX <= barX + ENERGY_BAR_WIDTH &&
            ...
            tooltip.add(Component.literal("Superior Energy Storage"));
            ...
            tooltip.add(Component.literal("Capacity: 5,000,000 FE"));
            tooltip.add(Component.literal("Transfer: 100,000 FE/t"));
