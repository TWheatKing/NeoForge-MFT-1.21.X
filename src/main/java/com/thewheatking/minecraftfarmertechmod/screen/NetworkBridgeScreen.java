...
public class NetworkBridgeScreen extends AbstractContainerScreen<NetworkBridgeMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MinecraftFarmerTechMod.MOD_ID, "textures/gui/network_bridge_gui.png");
    public NetworkBridgeScreen(NetworkBridgeMenu menu, Inventory playerInventory, Component title) { super(menu, playerInventory, title); }
