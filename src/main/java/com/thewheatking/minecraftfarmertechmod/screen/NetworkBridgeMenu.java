...
/**
 * Network Bridge Menu for connecting separate energy networks
...
public class NetworkBridgeMenu extends AbstractContainerMenu {
    ...
    public NetworkBridgeMenu(int containerId, Inventory playerInventory, BlockEntity entity, ContainerData data) {
    ...
    public boolean isBridging() { return data.get(0) > 0; }
    public int getNetwork1Energy() { return data.get(1); }
    public int getNetwork2Energy() { return data.get(2); }
    public int getTransferRate() { return data.get(3); }
